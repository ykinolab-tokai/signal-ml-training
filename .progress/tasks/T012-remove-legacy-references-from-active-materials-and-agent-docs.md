# T012 Remove legacy references from active handouts and agent docs
...
## Scope
- In: `handouts/`, `templates/`, and `AGENTS.md`.
...
## Acceptance Criteria
- [x] `handouts/` no longer referenced legacy notebook or exercise files.
