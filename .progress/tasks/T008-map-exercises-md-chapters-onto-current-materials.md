...
- Out: rewriting `exercises.md` itself.

## Deliverables
- A coverage mapping from exercises chapters to material handouts.
- A concrete edit plan for handout updates.
...
- owner: codex
- due: 2026-04-11
- action: Revisit the mapping if `exercises.md` gains new substantial chapters.
