...
![部屋の広さと家賃](../figures/source/21-regression-analysis/04_01.png)
...
![部屋の広さと家賃の関係](../figures/source/21-regression-analysis/04_02.png)
...
と表すことができます（[注釈1](#21-regression-analysis-note1)）。
...
![データの中心化](../figures/source/21-regression-analysis/04_03.png)
...
![中心化によるパラメータ削減](../figures/source/21-regression-analysis/04_04.png)
...
![目的関数を最小化するパラメータ](../figures/source/21-regression-analysis/04_05.png)
...
![家賃の予測値と目標値（中心化後）](../figures/source/21-regression-analysis/04_08.png)
...
![目的関数の概形（2 次元）](../figures/source/21-regression-analysis/04_06.png)

さらに、各次元が $w_1, w_2, L$ を表す 3 次元空間上においては、 $L$ の概形は下図のようになっています。

![目的関数の概形（3 次元）](../figures/source/21-regression-analysis/04_07.png)
...
### 注釈 1 {#21-regression-analysis-note1}
