...
![ニューラルネットワークの基本構造](../figures/source/23-basics-of-neural-networks/13_01.png)
...
![中間層のノード数が 3 の場合](../figures/source/23-basics-of-neural-networks/13_basic_network_1.png)
中間層のノード数が 3 の場合

![中間層のノード数が 5 の場合](../figures/source/23-basics-of-neural-networks/13_basic_network_2.png)
中間層のノード数が 5 の場合
...
![ニューラルネットワークの出力値](../figures/source/23-basics-of-neural-networks/13_02.png)
...
線形変換（[注釈1](#23-basics-of-neural-networks-note1)）とは、入力ベクトルを ${\bf h}_0$ としたとき（[注釈2](#23-basics-of-neural-networks-note2)）、重み行列 ${\bf W}_{10}$ と、バイアスベクトル ${\bf b}_1$ の 2 つを使って、次のような変換を行うことを言います。
...
![線形変換](../figures/source/23-basics-of-neural-networks/13_03.png)
...
![線形変換後の結果](../figures/source/23-basics-of-neural-networks/13_before_activation.png)
...
![入力と出力の関係](../figures/source/23-basics-of-neural-networks/13_04.png)
...
![非線形変換](../figures/source/23-basics-of-neural-networks/13_05.png)

#### ロジスティックシグモイド関数

活性化関数の具体例としては、下図に示す **ロジスティックシグモイド関数 (logistic sigmoid function)** が従来、よく用いられてきました。

![シグモイド関数](../figures/source/23-basics-of-neural-networks/13_06.png)
...
![ReLU関数](../figures/source/23-basics-of-neural-networks/13_07.png)
...
![計算の流れ](../figures/source/23-basics-of-neural-networks/13_08.png)
...
が求まりました。
ここでは、ニューラルネットワークを用いて回帰問題を解く場合について説明を行うため、最終出力層に活性化関数を用いていません（[注釈3](#23-basics-of-neural-networks-note3)）。
...
![平均二乗誤差](../figures/source/23-basics-of-neural-networks/13_09.png)
...
![パラメータと目的関数の関係（イメージ）](../figures/source/23-basics-of-neural-networks/13_10.png)

前節で説明したように、ニューラルネットワークのパラメータの初期値を決める必要があります。一般的に**ニューラルネットワークのパラメータは乱数で初期化されます。**
ここでは、例として $w=4$ という初期化が行われたと考えてみましょう。

![目的関数の接線の傾き](../figures/source/23-basics-of-neural-networks/13_11.png)
...
![パラメータの更新](../figures/source/23-basics-of-neural-networks/13_12.png)
...
![２度のパラメータの更新](../figures/source/23-basics-of-neural-networks/13_13.png)
...
ニューラルネットワークは、基本的に**微分可能な関数のみをつなげ合わせてできている**（[注釈4](#23-basics-of-neural-networks-note4)）ため、ニューラルネットワーク全体が表す関数も微分可能であり、訓練データセットを用いて勾配降下法によって目的関数を小さくする（局所）最適なパラメータを求めることができます。
...
![ミニバッチ学習](../figures/source/23-basics-of-neural-networks/13_14.png)
...
SGD を用いると、全体の計算時間が劇的に少なくできるだけでなく、下図のように目的関数が複数の谷を持っていたとしても、適当な条件のもとで "ほとんど確実に" **局所最適解**（[注釈5](#23-basics-of-neural-networks-note5)）に収束することが知られています。

![局所最適解と大域最適解](../figures/source/23-basics-of-neural-networks/13_15.png)
...
また、これらをまとめて $\boldsymbol{\Theta}$ と表すことにします。つまり、$\boldsymbol{\Theta} = \{ {\bf w}_1, {\bf b}_1, {\bf w}_2, {\bf b}_2 \}$ です（[注釈6](#23-basics-of-neural-networks-note6)）。

![パラメータ更新の例](../figures/source/23-basics-of-neural-networks/13_16.png)
...
勾配が求まりました。
これが $\frac{\partial L}{\partial {\bf w}_2}$ の値です（[注釈7](#23-basics-of-neural-networks-note7)）。
...
これが $\frac{\partial L}{\partial {\bf w}_1}$ の値です（[注釈7](#23-basics-of-neural-networks-note7)）。
...
![誤差逆伝播法 (backpropagation) の計算過程](../figures/source/23-basics-of-neural-networks/13_backpropagation.gif)
...
![シグモイド関数の導関数](../figures/source/23-basics-of-neural-networks/13_17.png)
