...
## この回の目標
- 第12回と第13回の baseline を、入力から出力まで口頭で説明できる。
...
## 演習
### 基礎レベル
1. `session14_oral_check_notes.md` を作成し、第12回の音響 baseline と第13回の画像 baseline について、`## 音響 baseline の入力`, `## 音響 baseline の model 出力`, `## 音響 baseline の推論例`, `## 画像 baseline の入力`, `## 画像 baseline の model 出力`, `## 画像 baseline の推論例` の 6 見出しで整理する。
...
6. `session14_oral_check_notes.md` に `## 想定質問` を追加し、画像 baseline 3 問、音響 baseline 3 問の答えを書く。
...
- 第12回と第13回の保存物 file 名が note 内に書かれている。
